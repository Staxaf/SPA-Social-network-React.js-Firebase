...
let initialState = {
    postsData: [
        {
            id: 1,
            message: 'Today I would like to tell you about polution. We cannot imagine our life without polution. As for me it is very important problem. By the way, polution can destroy our world. Lets make our world cleaner!',
            likeCounts: 25,
            dislikeCounts: 1,
            viewCounts: 256,
            newCommentText: '',
        ...
        },
        {
            ...
            comments: [
                {
                    image: 'https://static.boredpanda.com/blog/wp-content/uploads/2016/07/wild-animal-photography-konsta-punkka-10.jpg',
                    name: 'John',
                    dateOfPublishing: getStringDate(),
                    text: 'And what?'
                }
